// This file is almost full copy of https://github.com/dotnet/dotnet/blob/main/src/runtime/src/libraries/System.Collections/src/System/Collections/Generic/PriorityQueue.cs
// It is copied because the original implementation do a lot of memory invocation and do not support capacity.
...
namespace BrainAI.Pathfinding
{
    ...
    {
        #region Custom implementation of unused nodes storage
        internal LinkedListNode<T> unused;

        private LinkedListNode<T> GetOrCreateNode(LinkedList<T> list, T value)
        {
            LinkedListNode<T> result;
            if (unused == null)
            {
                result = new LinkedListNode<T>(list, value);
            }
            else
            {
                result = unused;
        ...
        {
            ValidateNode(node);
            LinkedListNode<T> result = this.GetOrCreateNode(node.list, value);
        ...
        {
            LinkedListNode<T> result = this.GetOrCreateNode(this, value);
            if (head == null)
            {
